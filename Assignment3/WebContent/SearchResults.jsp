...
<script>
	...
	*/
	...
	function det(i, result){
        ...
        sessionStorage.setItem("id", result.items[i].id);
        return true;
	}
	...
	for (var i = 0; i < result.items.length; i++) {
        ...
        document.getElementById("content").innerHTML += "<a rel=\"noopener\" href=\"DetailServlet?curruser=" + usernow 
        	+ "&id=" + id + "\" onclick=\"return det(" 
        	+ i + ",result);\"><img src=\""
        	+ image
